...
import DV from '../components/Final Resume.pdf'
    ...
    <>
      ...
      >
        <Link class="navbar-brand js-scroll-trigger" to="/">
          <span class="d-block d-lg-none">Suresh Rokaya</span>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item ">
              <a class="nav-link js-scroll-trigger" href={DV} download="Resume" target="_blank">
